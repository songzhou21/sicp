...
#;((flip-horiz wave-painter) unit-frame)
#;((rotate180 wave-painter) unit-frame)
#;((rotate270 wave-painter) unit-frame)
...
#;((right-split wave-painter 1) unit-frame)
#;((corner-split wave-painter 1) unit-frame)
#;((square-limit wave-painter 4) unit-frame)

;; a

(define wave-painter2
  (segments->painter
   (list
    (make-segment (make-vect 0.5 0.4) ;;; leg triangle
                  (make-vect 0.6 0))
...
#;((square-limit2 wave-painter 4) unit-frame)
...
#;(((square-of-four flip-horiz identity rotate180 flip-vert) wave-painter) unit-frame)
((square-limit3 wave-painter 4) unit-frame)
